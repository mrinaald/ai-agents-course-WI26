...
due_date: 2025-03-03 23:59:00
materials:
   -
      name: hw3-aidm.ipynb
      url: https://github.com/pearls-lab/ai-agents-course-WI26/tree/main/homeworks/hw3/hw3-aidm.ipynb
...
1. **Gain familiarity with Kani and function calling** - You will learn how Kani can be used to expose external APIs to
   LLMs by connecting them with a dice rolling library.
...
- Your Triton AI API Key or [Open AI API key](https://platform.openai.com/api-keys)
...
You should replace `sk-helicone-XXXXXXX-XXXXXX` with your Triton AI API Key (or OpenAI API key which you can
